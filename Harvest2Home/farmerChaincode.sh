...
# peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.harvest2home.com  --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n Harvest2home --peerAddresses localhost:7051 --tlsRootCertFiles $FARMER_PEER_TLSROOTCERT --peerAddresses localhost:9051 --tlsRootCertFiles $DELIVERYPARTNER_PEER_TLSROOTCERT --peerAddresses localhost:10051 --tlsRootCertFiles $CONSUMERASSOCIATION_PEER_TLSROOTCERT --peerAddresses localhost:12051 --tlsRootCertFiles $QUALITYASSURANCE_PEER_TLSROOTCERT -c '{"function":"addProduct","Args":["prod001", "Apple", "fruit", "25", "100","farmer1"]}'

# peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.harvest2home.com  --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n Harvest2home --peerAddresses localhost:7051 --tlsRootCertFiles $FARMER_PEER_TLSROOTCERT --peerAddresses localhost:9051 --tlsRootCertFiles $DELIVERYPARTNER_PEER_TLSROOTCERT --peerAddresses localhost:10051 --tlsRootCertFiles $CONSUMERASSOCIATION_PEER_TLSROOTCERT --peerAddresses localhost:12051 --tlsRootCertFiles $QUALITYASSURANCE_PEER_TLSROOTCERT -c '{"function":"addProduct","Args":["prod002", "Banana", "fruit", "20", "150", "farmer2"]}'

# peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.harvest2home.com  --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n Harvest2home --peerAddresses localhost:7051 --tlsRootCertFiles $FARMER_PEER_TLSROOTCERT --peerAddresses localhost:9051 --tlsRootCertFiles $DELIVERYPARTNER_PEER_TLSROOTCERT --peerAddresses localhost:10051 --tlsRootCertFiles $CONSUMERASSOCIATION_PEER_TLSROOTCERT --peerAddresses localhost:12051 --tlsRootCertFiles $QUALITYASSURANCE_PEER_TLSROOTCERT -c '{"function":"addProduct","Args":["prod003", "Carrot", "vegetable", "15", "200", "farmer3"]}'

# peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.harvest2home.com  --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n Harvest2home --peerAddresses localhost:7051 --tlsRootCertFiles $FARMER_PEER_TLSROOTCERT --peerAddresses localhost:9051 --tlsRootCertFiles $DELIVERYPARTNER_PEER_TLSROOTCERT --peerAddresses localhost:10051 --tlsRootCertFiles $CONSUMERASSOCIATION_PEER_TLSROOTCERT --peerAddresses localhost:12051 --tlsRootCertFiles $QUALITYASSURANCE_PEER_TLSROOTCERT -c '{"function":"addProduct","Args":["prod004", "Tomato", "vegetable", "30", "250", "farmer4"]}'

# peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.harvest2home.com  --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n Harvest2home --peerAddresses localhost:7051 --tlsRootCertFiles $FARMER_PEER_TLSROOTCERT --peerAddresses localhost:9051 --tlsRootCertFiles $DELIVERYPARTNER_PEER_TLSROOTCERT --peerAddresses localhost:10051 --tlsRootCertFiles $CONSUMERASSOCIATION_PEER_TLSROOTCERT --peerAddresses localhost:12051 --tlsRootCertFiles $QUALITYASSURANCE_PEER_TLSROOTCERT -c '{"function":"addProduct","Args":["prod005", "Potato", "vegetable", "10", "300", "farmer5"]}'



# peer chaincode query -C $CHANNEL_NAME -n Harvest2home -c '{"function":"getProduct","Args":["prod001"]}'

# peer chaincode query -C $CHANNEL_NAME -n Harvest2home -c '{"function":"getAllProducts","Args":[]}'

# peer lifecycle chaincode querycommitted -C $CHANNEL_NAME --name Harvest2home
