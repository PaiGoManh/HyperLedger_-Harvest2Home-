...
import farmerlogo from '../assets/farmersvg.png'
import farmer from '../assets/farmerlogin.png'
  ...
  return (
    <div className='w-[700px] h-[500px] border border-gray-300 shadow-lg mt-[5%] mx-auto rounded-lg flex overflow-hidden'>
      ...
      <div className='w-1/2 p-6 flex flex-col items-center'>
        ...
        <h2 className='text-2xl font-semibold text-gray-800 mb-4'>Farmer Login</h2>
        ...
        <form className='w-full flex flex-col gap-4'>
          ...
          <Link to='/farmer/' type='submit' className='pl-2 w-full py-2 bg-[#111D2D] text-white font-semibold rounded-md hover:bg-black'>
            Login
          </Link>
